...
gpcas.geometry.LmtTable = function (foo) {
    this.top_node = foo;
};
...
/////////////   OperationType //////////////////////////////////
var OperationType = gpcas.geometry.OperationType = function (type) {
    this.m_Type = type;
}
 ...
 */
var PolyDefault = gpcas.geometry.PolyDefault = function (isHole) {
 ...
 * @author  Dan Bridenbecker, Solution Engineering, Inc.
 */
var PolySimple = gpcas.geometry.PolySimple = function () {
    /**
...
for (var prop in gpcas.geometry) {
    global[prop] = gpcas.geometry[prop];
}
